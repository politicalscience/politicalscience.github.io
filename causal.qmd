...
In the last chapters, we focused on the classical and generalised linear regression model, and how it can explain relationships (correlations) between variables.
