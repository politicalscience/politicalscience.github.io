...
This is an unbiased estimator because selection bias is eliminated with randomisation. This is also an asymptotically consistent estimator due to the [law of large numbers](quant3.qmd#asymptotically-consistent-estimators).
...
We do not need to include covariates. This is because randomisation allows us to meet the [asymptotic consistency](quant3.qmd#asymptotic-consistency-of-ols) condition of both randomisation and exogeneity.
...
We can also use [Nonparametric Bootstrap](quant3.qmd#nonparametric-bootstrap) to create our sampling distribution for statistical inference, instead of relying on asymptotic normality of the standard t-test.
