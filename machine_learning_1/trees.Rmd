...
-   In a set of $n$ observations of predicted mean $\bar{Z}$, $Z_1, Z_2, ... , Z_n$, each with variance $\sigma^2$, the variance of the mean $\bar{Z}$'s of the observations is $\sigma^2/n$
