...
Players can also "update" their beliefs based on new information from prior events in the game. They do this updating via [Bayes' Rule](math.qmd#bayes-rule).
...
1.  Separating Equilibrium (see below)
2.  Pooling Equilibrium (see below)
3.  Semi-separating equilibrium (we are not too concerned with this).
