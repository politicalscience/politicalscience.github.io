...
In the last chapter, we discussed the basics of statistics, and briefly introduced regression as a way to find correlations.
...
We will discuss the OLS estimator in far more detail in the [next chapter](quant3.qmd).
...
If you have homoscedasticity, you should use normal OLS standard errors (derived below).

If you have heteroscedasticity, you should use robust OLS standard errors. You should also use robust standard errors if you are not sure which errors to use. We will not derive robust standard errors in this chapter.
...
Thus, our standard errors (square root of variance) for any coefficient estimate $\hat\beta_j$ are:
