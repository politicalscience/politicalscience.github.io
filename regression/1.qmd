...
This lesson introduces multiple linear regression, the foundational model for all of statistics. We cover the specification of the model, estimation and statistical inference, as well as extensions.
...
For more detailed analysis of the OLS estimator, see the [causal inference](https://politicalscience.github.io/causal/1.html) section.
