...
Logistic regression is used when we are trying to use X to predict a categorical/binary/factor Y variable. For example - if our goal is to use a few independent variables to predict Y - whether a country is a democracy or not (Yes/No is binary/categorical).
