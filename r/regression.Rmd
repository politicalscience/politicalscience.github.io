...
A simple linear regression is a method to create a prediction of Y, given a value of X (**Y \~ X)**. OLS is generally only used on continuous Y variables (not categorical Y variables).
...
In R, we can do this quite simply by adding onto the Single Linear Regression format. In the example below:
