...
-   Now lets create a variable: **apple or not** ($x_1$). We will define $x = 0$ as **not apple**, and $x = 1$ as **apple**.
-   Now lets create a second variable: **google or not** ($x_2$). We will define $x = 0$ as **not google**, and $x = 1$ as **google**.
