...
-   [Understanding Our Data: head(), tail(), glimpse()]

-   [Selecting and Filtering Data: select(), filter()]

-   [Rearranging/Sorting Data: arrange()]

-   [Adding Columns: mutate(), transmute()]

-   [Renaming Columns: colnames(), rename()]

-   [Merging Data Frames: merge(), leftjoin()]
