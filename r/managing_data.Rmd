...
-   Note: the syntax of **1:3** means all integers between 1 and 3, including 1 and 3. For example, 2:20 would be counting 2, 3, 4, 5, .... 20.

-   Note: for including/excluding non-continuous rows/columns, we can use the **c()** function. See the example of subset5.
...
# only keeping first 100 rows, and keeping all columns except 2
subset5_df <- df[1:100,-c(3,5)]
glimpse(subset5_df)
