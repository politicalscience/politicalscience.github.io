...
| [Sharp Regression Discontinuity](#sharp-regression-discontinuity) | When treatment is assigned in the real-world by some cut-off value of some variable.                                                                             | LATE      |
| [Fuzzy Regression Discontinuity](#fuzzy-regression-discontinuity) | When treatment is assigned in the real-world by some cut-off value of some variable, but there is some non-compliance.                                           | LATE      |
...
## Fuzzy and Kink Discontinuity {#fuzzy-regression-discontinuity}
