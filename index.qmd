...
|                                                                                                                                                                                                                                     |
| This course explains the key statistical and econometric techniques to test social science causal hypotheses with real-world data. Topics include regression, experiments, and quasi-experimental methods, and measurement methods. |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| #### [Applied Data Science and Prediction (for Social Scientists)](https://politicalscience.github.io/datascience)                                                                                                                  |
|                                                                                                                                                                                                                                     |
| This course discusses methods of prediction and forecasting, borrowing from techniques in Data Science, Time Series, and quantitative text analysis.                                                                                |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
