---
title: "Methods for Political Science"
subtitle: "Notes and Guides on Quantitative Methods for Political Science"
format:
    html:
        page-layout: article
        grid:
...
This site contains a collection of notes and courses/guides on quantitative methods for political science (and social sciences in general). There are three main categories of methods included: econometric methods, game theory, and quantitative methods.
...
|                                                                                                                                                                                                                                 |
| This course explains the key statistical and econometric techniques to empirically analyse political phenomena. Focuses include causal inference, prediction, and measurement. Implementation in R and Stata is also explained. |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
