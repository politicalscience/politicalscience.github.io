...
-   Some math background from Mathematics for Political Science would be very useful
...
-   This course assumes knowledge up to the end of module 3 of Statistics/Econometrics for Political Science
...
| \# | Module | Lesson Topics |
|------|------------------------------------------|------------------------|
| 1 | Topics in Algebra | Algebra Basics, Exponents and Logarithms, Summation and Product Notation, Functions and Roots, Limits and Continuity |
