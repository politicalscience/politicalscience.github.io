...
I include resources on theoretical statistics, applied statistics, and game theory. The applied statistics sections are linked to an external webpage that I have also created, and that one is more "polished".
