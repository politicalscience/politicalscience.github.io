...
|                                                                                                                                                                                                                                |
| This course explains the key statistical and econometric techniques to empirically analyse political phenomena. Topics include statistical inference and regression, methods for causal inference, and measurement techniques. |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                                                                                                                                                                                                                |
| This course introduces key mathematical techniques, probability theory, and statistical theory that are necessary for the study of political science. This is meant to be a "companion" to the other two courses.              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
