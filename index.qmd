...
| Module | Description |
|--------------------------------------------|---------------------------------------------------------------------|
| 1 Essential Mathematics | Topics in algebra, calculus, and linear algebra |
| 2 Essential Probability | Topics in sets, probabilities, and random variables |
...
| Module | Description |
|----------------------------|--------------------------------------------|
| [3 Introductory Statistical Inference](https://politicalscience.github.io/statistics/1.html) | Statistical inference from sampling and hypothesis testing |
| 4 Linear Regression Analysis | Detailed analysis of the linear regression model |
| 5 Other Regression Methods | Analysis of logistic regression and regression for counts |
...
| Module | Description |
|--------------------------------------------|---------------------------------------------------------------------|
| 6 Causal Frameworks and Randomisation | Disucssion of causal inference and controlled randomised experiments |
| 7 Selection on Observables |  |
| 8 Instrumental Variables |  |
| 9 Quasi-Experimental Designs | Discussion of regression discontinuity and difference-in-differences designs |
...
| Module | Description |
|--------------------------------------------|---------------------------------------------------------------------|
| 10 Static Games | Introduction to game theory, equilibrium concepts, and static games |
| 11 Dynamic Games of Complete Information | Discussion of non-simultaneous games and repeated games |
| 12 Bayesian Games | Discussion of dynamic games of incomplete information and perfect bayesian equilibria |
...
| Module | Description |
|--------------------------|----------------------------------------------|
| 16 Prediction Methods | Discussion of non-linear and tree-based prediction methods |
| 17 Classification Methods | Discussion of Naive Bayes and tree-based classifiers |
| 18 Model Selection and Regularisation | Discussion of model selection, and regularisation techniques such as Lasso and Ridge |
| 19 Text Mining | Introduction to the use of machine learning techniques to analyse textual data |
