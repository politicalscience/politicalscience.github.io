...
|                                                                                                                                                                                                                       |
| This course explains the key statistical and econometric techniques to empirically analyse political phenomena. Focuses include causal inference, prediction, and measurement. Implementation in R is also explained. |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| #### [Game Theory and Political Economics](https://politicalscience.github.io/gametheory)                                                                                                                             |
|                                                                                                                                                                                                                       |
| This course introduces mathematical modelling of political situations, borrowing heavily from microeconomic theory and game theory.                                                                                   |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
