...
subtitle: "A Guide to Statistical Methods in the Social Sciences"
format:
    html:
        theme: flatly
        max-width: 800px
...
This is a collection of materials and information on statistical methods in political science and the social sciences, that I have compiled over my years of studying political science. This handbook is divided into sections, which are further subdivided into modules, which are further subdivided into chapters. The appendix contains notes on mathematics relevant to some of the methods.
