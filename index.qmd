...
This site contains a collection of notes on quantitative methods for political science (and social sciences in general). I learned these methods throughout my undergraduate and postgraduate degrees in Political Science.
...
|                                                                                                      |
| Statistical theory and econometric theory, mainly focused on inference and regression analysis.      |
+------------------------------------------------------------------------------------------------------+
| #### [Applied Econometric Methods](https://politicalscience.github.io/applied)                       |
|                                                                                                      |
| Applies statistical and econometric theory to answering causal questions in social science research. |
+------------------------------------------------------------------------------------------------------+
| #### [Multivariate Statistical Methods](https://politicalscience.github.io/multivariate)             |
|                                                                                                      |
| Developing methods to reduce dimensionality in data, and measure latent variables.                   |
+------------------------------------------------------------------------------------------------------+
| #### [Time Series Analysis](https://politicalscience.github.io/time)                                 |
|                                                                                                      |
| Explores time-series data and forecasting.                                                           |
+------------------------------------------------------------------------------------------------------+
| #### [Applied Machine Learning](https://politicalscience.github.io/machine)                          |
|                                                                                                      |
| Explores machine learning prediction methods and text analysis methods.                              |
+------------------------------------------------------------------------------------------------------+
...
+:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:+
| #### [Game Theory and Formal Modelling](https://politicalscience.github.io/gametheory)                                                                                                                        |
|                                                                                                                                                                                                               |
| This course introduces mathematical modelling of political situations with Game Theory.                                                                                                                       |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
