...
+:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:+
| #### [Statistical Analysis for Social Scientists](https://politicalscience.github.io/metrics)                                                                                                                 |
|                                                                                                                                                                                                               |
| Introducing key statistical and econometric theory, and implementing this theory into research designs for the social sciences.                                                                               |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| #### [Game Theory and Formal Modelling](https://politicalscience.github.io/gametheory)                                                                                                                        |
|                                                                                                                                                                                                               |
| This course introduces mathematical modelling of political situations with Game Theory, and how Game Theory can be applied to research in Political Science and Political Economics.                          |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| #### [Applied Machine Learning](https://politicalscience.github.io/machine)                                                                                                                                   |
|                                                                                                                                                                                                               |
| Explores machine learning prediction methods and text analysis methods. Requires an understanding of Part I of the Statistical Analysis for Social Scientists course.                                         |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
