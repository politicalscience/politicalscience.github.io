...
This site contains a collection of notes and courses/guides on quantitative methods for political science. There are three main categories of methods included: econometric methods, game theory, and quantitative methods.
...
+:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:+
| #### [Econometric Methods (for Political Science)](https://politicalscience.github.io/metrics)                                                                                                                                  |
|                                                                                                                                                                                                                                 |
...
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| #### [Quantitative Methods (for Political Science)](https://politicalscience.github.io/maths)                                                                                                                                   |
|                                                                                                                                                                                                                                 |
