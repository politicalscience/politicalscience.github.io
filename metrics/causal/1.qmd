...
-   If $x$ is categorical, see [section 1.7](https://politicalscience.github.io/metrics/causal/1.html#binary-and-categorical-explanatory-variables) for interpretation.
-   If $y$ is binary, see [section 1.8](https://politicalscience.github.io/metrics/causal/1.html#binary-outcome-variables-and-the-linear-probability-model) for interpretation.
