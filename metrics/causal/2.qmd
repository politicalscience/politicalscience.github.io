---
title: "Chapter 2: Introduction to Causal Relationships and Causal Effects"
...
format:
    html:
        ...
        toc-location: left
        toc-expand: true
        toc-title: "Chapter 2: Introduction to Causal Relationships and Causal Effects"
...
We defined what correlation was in [section 1.1](https://politicalscience.github.io/metrics/causal/1.html#correlations-and-measuring-relationships-between-variables). For review, these are the sources of correlation:
...
We discussed a little about sampling in [section 1.6](https://politicalscience.github.io/metrics/causal/1.html#uncertainty-and-standard-errors). We can actually think about sampling in terms of observed outcomes.
...
-   Our sample is the observed outcomes that are realised in the real world.

This will become useful when we run hypothesis testing for causal inference.
...
1.  The ATT (see [section 1.4](https://politicalscience.github.io/metrics/causal/1.html#causal-estimands))
