...
-   [If conditions are met, we have an unbiased estimator in OLS for causal estimation]{.underline}.
-   [The key issue is assumption 3: Zero conditional mean $\mathbb{E}[u | x] = 0$]{.underline}, which is the most easily violated of these assumptions. We will explore this in detail in section 4.7.
