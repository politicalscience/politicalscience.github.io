...
-   The **independent variable**, also called the **explanatory variable** or **treatment variable**, is the variable that we believe is doing the causing. It is typically notated $x$ (or $D$ if binary).
...
Only under specific circumstances can we use regression and best-fit lines to estimate causation. That will be the focus of the [next chapter](https://politicalscience.github.io/metrics/causal/4.html). This chapter focuses on the basics of regression (although we will briefly discuss causality).
:::
...
-   Remember, this is the **relationship**, not the causal effect. We will discuss causality later.
:::
...
-   We will further discuss this in section 3.8
