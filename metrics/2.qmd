---
title: "Estimates and Statistical Inference"
subtitle: "Chapter 2: Estimates and Statistical Inference"
format:
    html:
        page-layout: article
        grid:
        ...
        toc-location: left
        toc-expand: true
        toc-title: "Chapter 2: Estimates and Statistical Inference"
...
# 2.1: Learning about Populations through Samples
...
# 2.2: Estimands, Estimators, and Estimates
...
An estimate is the value produced by an estimator. It is our guess of what the true population parameter is. We typically notate an estimate as $\hat\theta_n$.
:::

The rest of this chapter will be focused on the properties of these estimates.
...
# 2.3: Uncertainty in Estimates and Sampling Distributions
...
Recall from [section 1.6](https://politicalscience.github.io/metrics/1.html#the-normal-distribution), we explained how the normal distribution has some very useful properties in terms of standard deviations.
...
# 2.5: Intuition of Hypothesis Testing
...
In social sciences, we generally accept 95% confidence as the standard level. That means that if we get an estimate $\hat\theta$ that has less than a 5% chance of occuring given the null hypothesis is true, that means we can reject the null hypothesis.
...
# 2.6: Implementing a Hypothesis Test
...
In this chapter, we have mostly discussed sampling distributions. Notably, we said two things about sampling distributions:
...
This course will explore many different estimators, and their properties of unbiasedness and variance.
