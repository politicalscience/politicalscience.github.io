...
In [section 1.7](https://politicalscience.github.io/metrics/1/1.html#selection-bias-and-confounding-variables), we discussed how confounder $C$ affects which observations get the treatment, which introduces selection bias.
