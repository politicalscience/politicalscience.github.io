---
title: "Chapter 1: Introduction and Basics of Statistics"
format:
    html:
        page-layout: article
        grid:
...
# 1.1: Introduction to Statistics and Econometrics
...
3.  Finally, we will finish by introducing additional methods that solve some of the weaknesses of the linear regression model.
...
Random variables are events that have some randomness in their outcomes:
...
![](images/clipboard-713724518.png){fig-align="center" width="50%"}
...
![](images/clipboard-1038590923.png){fig-align="center" width="70%"}
...
![](images/clipboard-352151225.png){fig-align="center" width="60%"}
...
![](images/clipboard-2268260367.png){fig-align="center" width="80%"}
...
# 1.7: The Standard Normal Distribution
...
The below is the standard normal distribution, centered on 1, with each standard deviation being equal to 1:

![](images/img_standard_normal.svg){fig-align="center" width="80%"}
...
![](images/clipboard-1130923565.png){fig-align="center" width="60%"}
