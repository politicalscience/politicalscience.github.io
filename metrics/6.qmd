...
-   Multiple linear regression allows us to "control for the effect" of confounders. We will discuss this in [section 6.5](https://politicalscience.github.io/metrics/6.html#regression-anatomy-and-controlling-for-confounders).
