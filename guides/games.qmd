---
title: "Quick Guide to Game Theory"
...
$$
u_i(s_i^D, s_{-i}) > u_i (s_i, s_{-i}), \quad \forall \ s_{-i}, \ \forall s_i ≠ s_i^D
$$
...
$$
u_i(s_i^D, s_{-i}) > u_i (s_i, s_{-i}), \quad \forall \ s_{-i}, \ \forall s_i ≠ s_i^D, \ \forall \ i
$$
...
$$
u_i(s_i^*, s_{-i}^*) ≥ u_i(s_i', s_{-i}^*) \quad \forall \ s_i', \ \forall \ i
$$
...
$$
u_i(\sigma_i^*, \sigma_{-i}^*) ≥ u_i(\sigma_i', \sigma_{-i}^*) \quad \forall \ \sigma_i', \ \forall \ i
$$
...
-   The second equation expands $Pr(B)$ using the law of total probability.
