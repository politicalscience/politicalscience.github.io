...
{\underbrace{Pr(w_1 = 0|\theta_H)Pr(\theta_H)}_{\text{same as above}} + \underbrace{Pr(w_1 = 0|\theta_L)}_{1 \text{ (given by } \pi)} \underbrace{Pr(\theta_L)}_{1-p \text{ (prior)}}} \\
...
{\underbrace{Pr(w_1 = 1|\theta_H)Pr(\theta_H)}_{\text{same as above}} + \underbrace{Pr(w_1 = 1|\theta_L)}_{0 \text{ (given by } \pi)} \underbrace{Pr(\theta_L)}_{1-p \text{ (prior)}}} \\
...
\begin{split}
Pr(\theta_h | w_1 = 0) & = \frac{\overbrace{Pr(w_1 = 0|\theta_H)}^{0 \text{ (given by } \pi)} \overbrace{Pr(\theta_H)}^{p \text{ (prior)}}}
{\underbrace{Pr(w_1 = 0|\theta_H)Pr(\theta_H)}_{\text{same as above}} + \underbrace{Pr(w_1 = 0|\theta_L)}_{0.5 \text{ (given by } \pi)} \underbrace{Pr(\theta_L)}_{1-p \text{ (prior)}}} \\
& = \frac{0p}{0.5(1-p)} = 0
\end{split}
$$
...
\begin{split}
Pr(\theta_h | w_1 = 1) & = \frac{\overbrace{Pr(w_1 = 1|\theta_H)}^{1 \text{ (given by } \pi)} \overbrace{Pr(\theta_H)}^{p \text{ (prior)}}}
{\underbrace{Pr(w_1 = 1|\theta_H)Pr(\theta_H)}_{\text{same as above}} + \underbrace{Pr(w_1 = 1|\theta_L)}_{0.5 \text{ (given by } \pi)} \underbrace{Pr(\theta_L)}_{1-p \text{ (prior)}}} \\
