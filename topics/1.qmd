...
$$
\begin{split}
u_A(p_A) = & \underbrace{\left(\frac{1}{2} + \psi\left( \frac{|p_B| - |p_A|}{2}\right)\right)}_{\text{Pr A wins}}\underbrace{(-|p_A - q^A|)}_{\text{A's utility for }p_A} \\
& \qquad+ \underbrace{(1- \left(\frac{1}{2} + \psi\left( \frac{|p_B| - |p_A|}{2}\right) \right))}_{\text{Pr A loses}}\underbrace{(-|p_B - q^A|)}_{\text{A's utility for }p_B} \\
= & \left(\frac{1}{2} + \psi\left( \frac{|p_B| - |p_A|}{2}\right)\right)(-|p_A - q^A|) \\
& \qquad + (\frac{1}{2} - \psi\left( \frac{|p_B| - |p_A|}{2}\right))(-|p_B - q^A|)\\
\end{split}
$$
...
& \qquad + \left(\frac{1}{2} - \psi\left( \frac{p_B - p_A}{2}\right)\right)(-(p_B - q^A)) \\
= & \ \left(\frac{1}{2} + \psi\left( \frac{p_B - p_A}{2}\right)\right)(-p_A + q^A) \\
& \qquad + \left(\frac{1}{2} - \psi\left( \frac{p_B - p_A}{2}\right)\right)(-p_B + q^A)) \\
= & \ \left(\frac{1}{2} + \frac{\psi}{2}( p_B - p_A)\right)(-p_A + q^A) \\
& \qquad + \left(\frac{1}{2} - \frac{\psi}{2}( p_B - p_A)\right)(-p_B + q^A))
\end{split}
$$
...
& \qquad + \underbrace{(\frac{1}{2} - \frac{\psi}{2}( p_B - p_A))}_{u_2} \underbrace{(-p_B + q^A))}_{v_2} ] \\
...
& \qquad + \underbrace{\left( \frac{\psi}{2}\right)}_{u_2'} \underbrace{(-p_B + q^A)}_{v_1}
...
& \qquad+ \left( \frac{\psi}{2}\right)(-p_B + q^A) \\
= & \left(\frac{\psi}{2}\right) (-(-p_A + q^A) + (-p_B + q^A)) \\
& \qquad- \left(\frac{1}{2} - \frac{\psi}{2}( p_B - p_A)\right)\\
