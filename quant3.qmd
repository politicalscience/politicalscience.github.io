...
The actual variance of OLS under homoscedasticity was derived in the [previous chapter](quant2.qmd#deriving-standard-errors).
...
Using vector notation, [law of large numbers](#asymptotically-consistent-estimators), and zero-mean and exogeneity condition, we can simplify the above to:
