...
The model is always estimated with OLS + robust standard errors, as the [bernoulli distribution](random.qmd#bernoulli-and-binomial-distribution)'s variance is inherently heterscedastic. For estimation with OLS and robust standard errors in R, we should use the *fixest* package:
...
For mechanical details on least squares and robust standard errors, see [here](ols.qmd#ordinary-least-squares).
