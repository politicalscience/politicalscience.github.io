...
1.  The first model is a binary of category 1 vs. categories 2-4.
2.  The second model is a binary of categories 1-2 vs. categories 3-4.
3.  The third model is a binary of categories 1-3 vs. category 4.

![](images/clipboard-1556270979.png){fig-align="center" width="60%"}
...
![](images/clipboard-3226102876.png){fig-align="center" width="50%"}
...
Interpretation of the coefficients $\beta_1, \dots, \beta_p$ use [odds ratios](#interpretation-with-odds-ratios) as discussed above. An increase in one unit of $X_I$ increases the odds of a unit being in a higher category of $Y_i$ by a multiplicative increase of $e^{\beta_j}$.
