...
This module will provide the foundations of algebra, that are essential for the remainder of the modules. We start off with set theory - which provides important notation and concepts for the rest of the course, and for all political science methods. Then, we discuss key algebra concepts needed for more advanced concepts. Finally, we introduce functions and limits, which are the building blocks of calculus, game theory, and statistics
...
### 2.3: Factoring and Difference of Squares
...
# Chapter 3: Sum & Product Notation
...
### 3.3 Converting Between Sum and Product
